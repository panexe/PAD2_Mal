...
void NewBookingDialog::on_comboBox_currentIndexChanged(int index)
{
    ...
    case 0:
        ...
        ui->change_label4->setText("Sitzpräferenz");
        break;
    case 1:
        this->type = 'H';
        ...
        ui->change_label4->setText("Raucherzimmer(0 | 1)");
        break;
    case 2:
        this->type = 'R';
        ui->change_box3->setVisible(true);
        ...
        ui->change_label4->setText("Versicherung");
        break;
    default:
        this->type = ' ';
    }
...
void NewBookingDialog::on_buttonBox_accepted()
{
    ...
    this->bookingDetails.emplace_back(ui->change_box3_2->text().toStdString());
