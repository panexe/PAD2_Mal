...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionTrip_Attributes = new QAction(MainWindow);
        actionTrip_Attributes->setObjectName(QString::fromUtf8("actionTrip_Attributes"));
        ...
        gridLayout->addWidget(Label_const, 3, 2, 1, 1);
        ...
        gridLayout->addLayout(gridLayout_2, 5, 3, 1, 1);
        ...
        gridLayout->addWidget(calendarWidget_to, 1, 3, 1, 1);
        ...
        gridLayout->addWidget(calendarWidget_from, 0, 3, 1, 1);

        tableView = new QTableView(centralWidget);
        tableView->setObjectName(QString::fromUtf8("tableView"));

        gridLayout->addWidget(tableView, 0, 2, 3, 1);
        ...
        menuFunktionen->addAction(actionTrip_Attributes);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionTrip_Attributes->setText(QApplication::translate("MainWindow", "Trip Attributes", nullptr));
